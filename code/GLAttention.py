...
class GLAttentionGeneral(nn.Module):
    ...
    def forward(self, input, sentence, context):
        ...
        weighted_context = torch.bmm(sourceT, attn)
        weighted_context = weighted_context.view(batch_size, -1, ih, iw)  # batch x idf x ih x iw
        ...
        # weighted_context: batch x idf x ih x iw
        # weighted_sentence: batch x idf x ih x iw
